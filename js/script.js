...
$(document).ready(function(){
	jQuery(document).ready(function($) { 
		$.ajax({ 
			url : "http://ws.audioscrobbler.com/2.0/?method=chart.gettoptracks&api_key=39b875f4c487778289f6bb6a8dc75c24&format=json", 
			dataType : "jsonp", 
			success : function(parsed_json) { 
				for(var i = 0; i<50; i++){
					...
					$(".results").append("<div class=\"result span4\"><img class=\"albumImage img-polaroid\" src=\""+imagen+"\" align=\"right\"><span3 class=\"topNumber span1\">#"+(i+1)+"</span><div class=\"span2\"><span>Track: </span> "+parsed_json["tracks"]["track"][i]["name"]+"<br><span>Artist: </span> "+parsed_json["tracks"]["track"][i]["artist"]["name"]+"<br><span>Played: </span> "+parsed_json["tracks"]["track"][i]["playcount"]+" times!<br><span>Length: </span> "+parsed_json["tracks"]["track"][i]["duration"]+"</div></div><br>");
				};
			} 
		}); 
	});
...
//************************** ocultar cuerpo ***********************************
//******************** boton 2 post related to human envy...!!******************$(document).ready(function() {
